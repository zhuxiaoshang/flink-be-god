...
import org.apache.flink.formats.parquet.utils.ParentDataHolder;
import org.apache.flink.formats.parquet.utils.ParquetTimestampUtils;
...
public class RowConverter extends GroupConverter implements ParentDataHolder {
    ...
    private static Converter createConverter(
        ...
        if (field.isPrimitive()) {
            ...
            if (typeClass.equals(Character.class)) {
                return new ArrayConverter<Character>(
                        elementType,
                        Character.class,
                ...
                return new ArrayConverter<Boolean>(
                        elementType,
                        Boolean.class,
                ...
                return new ArrayConverter<Short>(
                        elementType,
                        Short.class,
                ...
                return new ArrayConverter<Integer>(
                        elementType,
                        Integer.class,
                ...
                return new ArrayConverter<Long>(
                        elementType,
                        Long.class,
                ...
                return new ArrayConverter<Double>(
                        elementType,
                        Double.class,
                ...
                return new ArrayConverter<String>(
                        elementType,
                        String.class,
                ...
                return new ArrayConverter<BigDecimal>(
                        elementType,
                        BigDecimal.class,
    ...
    static Converter createArrayElementConverter(
        ...
        if (elementClass.equals(Row.class)) {
            ...
            return new RowPrimitiveConverter(elementType, holder, 0);
        }
    }
